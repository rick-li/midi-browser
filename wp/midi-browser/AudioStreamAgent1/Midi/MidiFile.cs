    ...
    public class MidiFile
    {
        ...
        public MidiFile(string filename)
        {
            ...
            try
            {
                ...
                //midiStream = Application.GetResourceStream(new Uri(filename, UriKind.Relative)).Stream;
                
                var isf = IsolatedStorageFile.GetUserStoreForApplication();
                midiStream = new IsolatedStorageFileStream(filename, FileMode.Open, isf);
                //midiStream = isf.OpenFile(filename, FileMode.Open).AsInputStream ;
