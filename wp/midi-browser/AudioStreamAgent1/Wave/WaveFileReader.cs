...
namespace CSharpSynth.Wave
{
    public class WaveFileReader
    {
        ...
        public WaveFileReader(string filename)
        {
            ...
            //filename = "SoundBanks/" + filename;
       
            /*filename = filename.Replace("GMBGMBank", "GMBank");
                filename = filename.Replace("EGMBank/", "");
                filename = filename.Replace("GMBanGMBank/", "GMBank");
                filename = filename.Replace("GMBankSAMPLES/", "GMBank");
            */
